            ...
            <div class="text-container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p>You will redirect to next page in 5 sec.</p>
...
<?php 
    ...
    echo "<p>Missing necessary parameters.</p>";
    // Debugging: Output the parameters to see if they are present in the URL
