...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <header id="header" class="ex-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="white">सेवा भारति माध्यमिक विद्यालय, सत्यनगर</h1>
                    <h4 class="white">हरियाणा सरकार द्वारा मान्यता प्राप्त</h4>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="index.php">सेवा भारति</a><i class="fa fa-angle-double-right"></i><span>सेवा भारति माध्यमिक विद्यालय, सत्यनगर</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="text-container">
                        <h3>सेवा भारति माध्यमिक विद्यालय, सत्यनगर</h3>
...
$category = "सेवा भारति माध्यमिक विद्यालय, सत्यनगर";
