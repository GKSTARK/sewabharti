...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <header id="header" class="ex-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="white"> सेवा भारती श्री माधव छात्रावास </h1>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="index.php">सेवा भारती</a><i class="fa fa-angle-double-right"></i><span>सेवा भारती श्री माधव छात्रावास </span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="text-container">
                        <div class="row">
                            <div class="col-md-6">
                                <h3>सेवा भारती श्री माधव छात्रावास</h3>
